    ...
    <div class="max-w-md w-full space-y-4 bg-gray-50 px-2 py-8 rounded-lg border">
      ...
      <form class="mt-8 space-y-6 ml-6" action="#" method="POST"  @submit.prevent="submit">
        ...
        <div class="rounded-md  space-y-4">
          <div>
            <base-input v-model="login_form.email" class="mr-6" :tipo="'email'" :label="'Email'" :hint="'Email Address'"></base-input>
          ...
          <div class=" flex items-end">
            <base-input v-model="login_form.password"  class="w-full" :tipo="password" :label="'Password'" :hint="'Password'"></base-input>
            <div class="flex justify-center mb-2">
              <svg v-if="!viewPass" xmlns="http://www.w3.org/2000/svg" class="hover:cursor-pointer h-6 w-6 pl-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"  @click="toggleView">
