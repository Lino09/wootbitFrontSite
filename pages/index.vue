                                            ...
                                            <blockquote>
                                                <div>
                                                    ...
                                                    <p class="mt-6 text-2xl font-medium text-white">
                                                        ...
                                                        urna nulla
                                                        vitae
                                                        laoreet augue. Amet feugiat est integer dolor auctor adipiscing
                                                        nunc
                                                        urna,
                                                        sit.
                                                    </p>
    ...
    this.$axios.setToken(process.env.apiTokenWootbit, 'Bearer')
     ...
     this.$axios.setToken(this.usertkn, 'Bearer')
      ...
      await this.$axios.$get('/api/projects').then( response => {
          ...
          console.log(error,'error no interceptado')
